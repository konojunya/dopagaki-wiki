...
.takeaway{color:${color("takeaway")};font-size:${theme.body}px;line-height:${type.body.lineHeight};padding:18px 24px;display:flex;align-items:flex-start;gap:${design.spacing.sm};border:${design.components.divider.height} solid ${colors.primary}}.takeaway-icon{flex:none}.takeaway>span:last-child{min-width:0}
